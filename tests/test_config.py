...
from agent.config import AppConfig, load_profile, get_env
from agent.tracker import ApplicationTracker
from agent.models import Job, Platform, AIResult
...
class TestApplicationTracker:
    ...
    def test_save_and_load(self):
        job = Job(title="Engineer", company="Corp", url="http://example.com", platform=Platform.LINKEDIN)
        ai_result = AIResult(match_score=80, matching_skills=["Python"], cover_letter="Test letter")
